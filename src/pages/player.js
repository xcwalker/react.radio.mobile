...
export function Player(propsIn) {
  ...
  useEffect(() => {
    if (props.station === "Simulator Radio") return;
      ...
      <section id="mobile" onLoad={() => setTicking(true)}>
        ...
        <ul className="container">
          <div className="item" id="live">
            ...
            {(djCount === 0 ? oldDJ : dj) &&
              (djCount === 0 ? oldDJ?.avatar : dj?.avatar) && (
                <div className="dj" data-count={djCount === 0 ? 0 : 1}>
                  ...
                  <div className="about">
                    <span className="title">
                      {djCount === 0 ? oldDJ?.displayname : dj?.displayname}
                    </span>
                    <ReactMarkdown className="subTitle">
                      {djCount === 0 ? oldDJ?.details : dj?.details}
                    </ReactMarkdown>
                  </div>
                </div>
              )}
            {(djCount === 0 ? dj : oldDJ) &&
              (djCount === 0 ? dj?.avatar : oldDJ?.avatar) && (
                <div className="dj" data-count={djCount === 0 ? 1 : 0}>
                  ...
                  <div className="about">
                    <span className="title">
                      {djCount === 0 ? dj?.displayname : oldDJ?.displayname}
                    </span>
                    <ReactMarkdown className="subTitle">
                      {djCount === 0 ? dj?.details : oldDJ?.details}
                    </ReactMarkdown>
                  </div>
                </div>
              )}
